...
function getHeadshotUrl(n) { const id = ESPN_IDS[n]; return id ? `https://a.espncdn.com/combiner/i?img=/i/headshots/nhl/players/full/${id}.png&h=96&w=96&scale=crop` : null; }.png&h=96&w=96&scale=crop` : null; }
